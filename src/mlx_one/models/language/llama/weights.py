"""Weight contract for dense Llama-family causal models."""
...
def sanitize_weights(weights: dict[str, Any], config: LlamaConfig) -> dict[str, Any]:
    sanitized = {
        name: value
...
def weight_contract(config: LlamaConfig) -> WeightContract:
