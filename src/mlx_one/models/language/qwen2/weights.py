"""Weight contract for dense Qwen2/Qwen2.5."""
...
def sanitize_weights(weights: dict[str, Any], config: Qwen2Config) -> dict[str, Any]:
    sanitized = {
        name: value
...
def weight_contract(config: Qwen2Config) -> WeightContract:
